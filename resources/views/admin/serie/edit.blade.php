...
@section('sidebar')
    @include('admin.sidebar', ['page' => 'serie'])
@endsection
        ...
        <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('admin.serie.index') }}" class="text-muted text-hover-primary">Diziler</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form class="form" method="POST" action="{{ route('admin.serie.update', $serie) }}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Card-->
                        <div class="card">
                            <!--begin::Card header-->
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-xl-9 fv-row">
                                        <input type="text" class="form-control form-control-solid @error('name') is-invalid @enderror" name="name" value="{{ old('name', $serie->name) }}" />
                                        @error('name')
                                ...
                                <div class="row mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-9 fv-row">
                                        <textarea name="description" id="description" cols="30" rows="10" class="form-control form-control-solid @error('description') is-invalid @enderror" style="resize: none">{!! old('description', $serie->description) !!}</textarea>
                                        @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-8">
                                    <!--begin::Col-->
                                    <div class="col-xl-3">
                                        <div class="fs-6 fw-semibold mt-2 mb-3 required">Sırası</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-xl-9 fv-row">
                                        <input type="text" class="form-control form-control-solid @error('row') is-invalid @enderror" name="row" value="{{ old('row', $serie->row) }}" />
                                        @error('row')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-8">
                                    <!--begin::Col-->
                                    <div class="col-xl-3">
                                        <div class="fs-6 fw-semibold mt-2 mb-3 required">Kapak Resmi</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-xl-9 fv-row">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <small class="text-success"><i class="fa fa-info-circle fa-fw"></i>Yeni bir görsel seçtiğinizde eskisi silinir.</small>
                                    </div>
                                </div>
                                <!--end::Row-->
                                @if($serie->cover_image)
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative" style="margin-top: 10px">
                                        <img src="{{ $serie->cover_image }}" alt="">
                                    </div>
                                @endif
                            </div>
                            <!--end::Card body-->
                        ...
                        <div class="card" style="margin-top: 35px">
                            ...
                            <!--end::Card header-->
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <a href="{{ route('admin.serie.index') }}" class="btn btn-light btn-active-light-primary me-2">Vazgeç</a>
