...
<head>
    ...
    <link href="{{ admin_asset('plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="index.html" class="d-lg-none">
                        <img alt="Logo" src="{{ admin_asset('media/logos/default-small.svg') }}" class="h-30px" />
                    </a>
                </div>
                <!--end::Mobile logo-->
                                ...
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog" target="_blank">
                                            ...
                                            <span class="menu-title">Changelog v8.3.0</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
...
<script src="{{ admin_asset('plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
...
<script src="{{ admin_asset('js/custom/utilities/modals/create-app.js') }}"></script>
