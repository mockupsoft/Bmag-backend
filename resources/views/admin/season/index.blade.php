            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ route('admin.season.create', $serie->id) }}" class="btn btn-sm fw-bold btn-primary">Sezon Ekle</a>
                        <!--end::Primary button-->
                    </div>
                    <!--end::Actions-->
                </div>
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                                ...
                                @if($seasons->count() > 0)
                                    @foreach($seasons as $season)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-gray-800 fs-5 fw-bold">{{ $season->name }}</span>
                                            </td>
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.episode.index', ['serieId' => $serie->id, 'seasonId' => $season->id]) }}" class="menu-link px-3">Bölümler</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
                                ...
                                @else
                                    <tr>
                                        <td colspan="3" class="text-center">Sezon Bulunamadı</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
