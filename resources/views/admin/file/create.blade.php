            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card">
                        ...
                        <!--end::Card header-->
                        <!--begin::Form-->
                        <form class="form" method="POST" action="{{ route('admin.file.store') }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-8">
                                    <!--begin::Col-->
                                    <div class="col-xl-3">
                                        <div class="fs-6 fw-semibold mt-2 mb-3">Dosya</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{ route('admin.file.index') }}" class="btn btn-light btn-active-light-primary me-2">Vazgeç</a>
